...
isp_storage_output <- bind_rows(combined_2020_final,
                                combined_2022_final,
                                combined_2024_final) |>  
...
save(isp_storage_output, file = "shiny-webtool/data/isp_storage_output.rda", compress = "xz")
write_csv(isp_storage_output,
          file = "data/isp_storage_output.csv")
